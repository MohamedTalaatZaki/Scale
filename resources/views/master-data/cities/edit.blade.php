                    ...
                    <form action="{{ route('cities.update' , ['id' => $city->id ]) }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlyEn" name="en_name" value="{{ old('en_name' , $city->en_name) }}" placeholder="@lang('global.en_name')" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlyAr" id="inputPassword1" name="ar_name" value="{{ old('ar_name' , $city->ar_name) }}"
