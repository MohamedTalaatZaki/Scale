                    ...
                    <form action="{{ route('items.update' , ['id' => $item->id]) }}" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" name="en_name" value="{{ old('en_name' , $item->en_name) }}" placeholder="@lang('global.en_name')" autocomplete="off" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control" id="inputPassword1" name="ar_name" value="{{ old('ar_name' , $item->ar_name) }}"
