    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h5 class="mb-4">@lang('global.edit_item_group')</h5>
                    </div>

                    <form action="{{ route('item-group.update' , ['id' => $item_group->id ]) }}" method="post">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label>@lang('global.en_name') *</label>
                                <input type="text" class="form-control" name="en_name" value="{{ old('en_name' , $item_group->en_name) }}" placeholder="@lang('global.en_name')" autocomplete="off" required>
