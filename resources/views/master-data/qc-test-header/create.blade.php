                    ...
                    <form action="{{ route('qc-test-headers.store') }}" class="repeater" method="post">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlyEn" name="en_name"
                                       value="{{ old('en_name') }}" placeholder="@lang('global.en_name')"
                                       autocomplete="off" required>
                                @if($errors->has('en_name'))
                                    <div id="jQueryName-error" class="error"
                                         style="">{{ $errors->first('en_name') }}</div>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                <label for="inputPassword1">@lang('global.ar_name') *</label>
                                <input type="text" class="form-control onlyAr" name="ar_name"
                                       value="{{ old('ar_name') }}"
                                       placeholder="@lang('global.ar_name')" autocomplete="off" required>
                                @if($errors->has('ar_name'))
                                    <div id="jQueryName-error" class="error"
                                         style="">{{ $errors->first('ar_name') }}</div>
                                @endif
                            </div>
                        </div>
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <select id="item_group_id" class="form-control select2-single"
                                        data-placeholder="@lang('global.item_group')" name="item_group_id" required>
                                ...
                                @if($errors->has('item_group_id'))
                                    <div id="jQueryName-error" class="error"
                                         style="">{{ $errors->first('item_group_id') }}</div>
                                @endif
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="custom-switch custom-switch-primary-inverse mb-2"
                                        ...
                                        <input class="custom-switch-input" id="is_active" type="checkbox" value="1"
                                               name="is_active" {{ old('is_active') == '0' ? '' : 'checked' }}>
                                        <label class="custom-switch-btn" for="is_active"></label>
                                    </div>
                                    @if($errors->has('is_active'))
                                        <div id="jQueryName-error" class="error"
                                             style="">{{ $errors->first('is_active') }}</div>
                                    @endif
                                </div>
                            </div>
                        </div>
                                    ...
                                    <tr data-repeater-item>
                                        ...
                                        <td>
                                            <input type="text"
                                                   ...
                                                   value="{{ old("details.$key.test_type") }}"
                                                   readonly>
                                        </td>
                                        <td>
                                            <input type="text"
                                                   ...
                                                   value="{{ old("details.$key.element_type") }}"
                                                   readonly>
                                        </td>
                                        <td>
                                            <select
                                                    class="form-control form-control-sm expected_result"
                                                    name="details[0][expected_result]" style="display: {{ old("details.$key.element_type") == "question"? "" : "none" }}">
                                        ...
                                        <td>
                                            <input type="text"
                                                   ...
                                                   value="{{ old("details.$key.element_unit") }}"
                                                   readonly>
                                        </td>
                                        <td>
