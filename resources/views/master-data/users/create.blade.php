                        ...
                        <div>
                            <a href="#" class="user-img">
                                <img id="user-img" src="{{ asset('img/GOHAINA.png') }}"
                                     style="{{$page_dir == 'rtl' ? 'right: 85%!important':'left: 95%!important' }};top: -55px!important;max-height: 114px;max-width: 114px;object-fit: contain"
                    ...
                    <form action="{{ route('users.store') }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <input type="email" class="form-control" id="inputPassword2" name="email" value="{{ old('email') }}"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState1" class="form-control" name="theme">
                                    <option value="light" {{ old('theme') == 'light' ? 'selected' : '' }}>@lang('global.light')</option>
                                    <option value="dark"  {{ old('theme') == 'dark' ? 'selected' : '' }}>@lang('global.dark')</option>
                                </select>
                                @if($errors->has('theme'))
                            ...
                            <div class="form-group col-md-4">
                                ...
                                <select id="inputState2" class="form-control" name="lang">
                                    ...
                                    <option value="en"  {{ old('lang') == 'en' ? 'selected' : '' }}>@lang('global.english')</option>
                                </select>
                                @if($errors->has('lang'))
