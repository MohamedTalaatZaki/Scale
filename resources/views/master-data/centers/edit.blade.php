    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div>
                        <h5 class="mb-4">@lang('global.edit_center')</h5>
                    </div>


                    <form action="{{ route('centers.update' , ['id' => $center->id]) }}" method="post">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlyEn" name="en_name" value="{{ old('en_name' , $center->en_name) }}" placeholder="@lang('global.en_name')" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control onlyAr" id="inputPassword1" name="ar_name" value="{{ old('ar_name' , $center->ar_name) }}"
                        ...
                        <div class="form-group row mb-1">
                            ...
                            <div class="col-12">
                                <div class="custom-switch custom-switch-primary-inverse mb-2" style="padding-left: 0">
                                    <input class="custom-switch-input" id="switch3" type="checkbox" value="1" name="is_active" {{ old('is_active' , $center->is_active) == '1' ? 'checked' : '' }}>
